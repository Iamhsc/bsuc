...
function getClickTimes(newsid, owner,type,randomid) { 
    var url = 'clicktimes.jsp.htm'/*tpa=http://www.bsuc.cn/system/resource/code/news/click/clicktimes.jsp*/; 
    if(!type) type="wbnews";
    if(!randomid)
    {
    	 randomid="n";
...
function _getBatchClickTimes(newsid, owner,type,randomid) { 
    var url = 'batchclicktimes.jsp.htm'/*tpa=http://www.bsuc.cn/system/resource/code/news/click/batchclicktimes.jsp*/; 
    if(!type) type="wbnews";
    if(!randomid)
    {
    	 randomid="n";
...
function addClickTimes(urlid,owner,type){
		var url = 'addclicktimes.jsp.htm'/*tpa=http://www.bsuc.cn/system/resource/code/news/click/addclicktimes.jsp*/; 
        var xmlHttp = createXMLHttpRequest();
