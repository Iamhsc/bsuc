...
function shareto(a,U,T,S,key)  
{
    ...
    A = 'weiboshare.htm'/*tpa=http://www.bsuc.cn/system/resource/news/weiboshare.htm*/;
...
function download_news(contentid,treeid,owner,newsid)
{
    if(checkobj_content(contentid))
    {
        ...
        {
            location.href='newstoword.jsp-treeid=.htm'/*tpa=http://www.bsuc.cn/system/resource/news/newstoword.jsp?treeid=*/+treeid+'&owner='+owner+'&wbnewsid='+newsid;
        }
    }else{
        location.href='newstoword.jsp-treeid=.htm'/*tpa=http://www.bsuc.cn/system/resource/news/newstoword.jsp?treeid=*/+treeid+'&owner='+owner+'&wbnewsid='+newsid;
    }
...
function showVsbAudio(aurl,vheight,vwidth,align,styles,vautoplay)
{
	...
	var playersrc = "player_mp3_maxi.swf"/*tpa=http://www.bsuc.cn/system/resource/images/ueditor/musicFlash/player_mp3_maxi.swf*/;
